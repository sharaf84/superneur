...
class XUploadForm extends CFormModel {
    ...
    public function rules() {
        ...
        unset($mimeTypes['js']);
        //'types' => 'txt, doc, docx, xls, xlsx, ppt, pptx, pdf, png, jpg, bmp, gif, 3g2, 3gp, asf, dif, dv, f4v, m2t, m2ts, m4v, mkv, mtv, mov, mp4, mpeg, mpg, mts, qt, ts, wmv'
        return array(
            array('file', 'file', 'types' => array_keys($mimeTypes)),
        );
    }
