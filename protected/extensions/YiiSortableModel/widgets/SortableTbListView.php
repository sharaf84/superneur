...
/**
 * TbListView widget extended to list records sorted.
 * @author Marc Busqué Pérez <marc@lamarciana.com>
 * @modified Ahmed Sharaf <sharaf.developer@gmail.com>
...
class SortableTbListView extends TbListView
{
   /**
    * @var boolean whether to list items sorted, which is the essence of this widget. If it's set to true items are listed ordered by the field defined in $orderField. It it's set to false the widget defaults to a normal TbListView and the rest of this extension widget properties are ignored. Defaults to true
    */
