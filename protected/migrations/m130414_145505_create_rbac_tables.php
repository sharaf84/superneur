...
class m130414_145505_create_rbac_tables extends CDbMigration {
    ...
    public function up() {
        ...
        //the tbl_auth_assignment.userid is a reference to mstql_users.id
        $this->addForeignKey("fk_auth_assignment_userid", "tbl_auth_assignment", "userid", "mstql_users", "id", "CASCADE", "CASCADE");
    }
