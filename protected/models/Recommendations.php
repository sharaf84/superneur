...
/**
 * This is the model class for table "sprnr_recommendations".
 *
 * The followings are the available columns in table 'sprnr_recommendations':
 * @property string $id
...
class Recommendations extends Base
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, from, to, created, note', 'safe', 'on'=>'search'),
		);
	}
