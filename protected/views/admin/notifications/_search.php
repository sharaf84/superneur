<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<?php echo $form->label($model, 'message', array('class' => 'form-label', 'for' => 'normal')).''.$form->textFieldRow($model,'message',array('class'=>'form-control','maxlength'=>255, 'labelOptions' => array('label' => false))).''.'<br /><br />'; ?>
