<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<?php echo $form->label($model, 'id', array('class' => 'form-label', 'for' => 'normal')).''.$form->textFieldRow($model,'id',array('class'=>'form-control','maxlength'=>11, 'labelOptions' => array('label' => false))).''.'<br /><br />'; ?>
