<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<?php echo $form->textFieldRow($model,'banned',array('class'=>'span5')); ?>

	<?php echo $form->textFieldRow($model,'token',array('class'=>'span5','maxlength'=>123)); ?>

	<?php echo $form->textFieldRow($model,'token_date',array('class'=>'span5')); ?>

	<?php echo $form->textFieldRow($model,'login_token',array('class'=>'span5','maxlength'=>123)); ?>
	...
	<?php echo $form->textFieldRow($model,'facebook_identifier',array('class'=>'span5','maxlength'=>255)); ?>
