...
class Metadata extends CApplicationComponent {
     ...
     * @param mixed $module special case 
     * if $module == 'admin' path will be 'protected/controllers/admin'
     * if $module == 'components' path will be 'protected/controllers/components' 
     * @return mixed
     */
    public function getActions($controller, $module = null) {
        ...
        ($module === 'admin') and $path = 'protected' . DIRECTORY_SEPARATOR . 'controllers' . DIRECTORY_SEPARATOR . 'admin'; //Added by sharaf
        ($module === 'components') and $path = 'protected' . DIRECTORY_SEPARATOR . 'components'; //Added by sharaf
